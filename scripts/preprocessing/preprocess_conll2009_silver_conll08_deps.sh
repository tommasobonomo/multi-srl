...
python3 scripts/preprocessing/preprocess_conll2009.py \
    ...
    --output data/preprocessed/conll2009/en_conll08/CoNLL2009_train.json \
    --add_predicate_pos \
    --keep_lemmas \
    --keep_dep_info
...
python3 scripts/preprocessing/preprocess_conll2009.py \
    ...
    --output data/preprocessed/conll2009/en_conll08/CoNLL2009_dev.json \
    --add_predicate_pos \
    --keep_lemmas \
    --keep_dep_info 
...
python3 scripts/preprocessing/preprocess_conll2009.py \
    ...
    --output data/preprocessed/conll2009/en_conll08/CoNLL2009_test.json \
    --add_predicate_pos \
    --keep_lemmas \
    --keep_dep_info
...
python3 scripts/preprocessing/preprocess_conll2009.py \
    ...
    --output data/preprocessed/conll2009/en_conll08/CoNLL2009_test_ood.json \
    --add_predicate_pos \
    --keep_lemmas \
    --keep_dep_info
...
python scripts/preprocessing/compute_vocabulary.py \
    --input data/preprocessed/conll2009/en_conll08/CoNLL2009_train.json \
    --output data/preprocessed/conll2009/en_conll08/vocabulary.json