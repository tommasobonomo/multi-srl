...
def load_model(checkpoint_path: str, vocabulary_path: str) -> SrlParser:
    ...
    model = SrlParser.load_from_checkpoint(
        checkpoint_path, vocabulary_path=vocabulary_path
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--text", type=str, required=False, dest="text", help="Text to parse."
    )
    parser.add_argument(
        "--output_file",
        type=str,
    ...
    nlp = trankit.Pipeline(lang=args.language, gpu=True, embedding="xlm-roberta-large")
